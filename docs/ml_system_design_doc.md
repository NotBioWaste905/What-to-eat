...
1. [Food Recognition 2022](https://www.kaggle.com/datasets/sainikhileshreddy/food-recognition-2022)
  - `MS-COCO format`
2. [Food 101](https://www.kaggle.com/datasets/dansbecker/food-101)
3. [147к кулинарных рецептов (с сайта povarenok.ru)](https://www.kaggle.com/datasets/rogozinushka/povarenok-recipes)
  - `.csv`
  - Столбцы: "url", "name", "ingredients"
4. [recipes 27к (с сайта 1000.menu)](https://www.kaggle.com/datasets/coolonce/recipes-and-interpretation-dim)
  - `.csv`
...
- Этап 1 - Скачивание данных рецептов с Kaggle (парсинг датасета "147к с сайта povarenok.ru") и их предобработка
