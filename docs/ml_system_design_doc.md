...
- Бейзлайн
  ...
  4. При количестве n>=5 рецептов после фильтрации выдача их пользователю
  5. При количестве n<=5 рецептов после фильтрации переходим на шаг 2 с выборкой n=100
- Анализ и интерпретация
...
- Системные требования
  ...
  - Успешная обработка ≥ 90% фотографий (без ошибок сервера)
- Бизнес-метрики
  - 80% пользователей экспериментальной группы используют функцию генерации меню ≥ 1 раза за неделю
